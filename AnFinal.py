...
class Programa:
    def __init__(self, definiciones, nodo):
        ...
        self.nodo = nodo
class Var:
    def __init__(self, fuente, contexto):
        self.fuente = fuente
...
class Term2:
    def __init__(self, fuente, tipo, context):
        self.fuente = fuente
        self.tipo = tipo
...
class Sintactico: 
    ...
    def remplazar(self, elim, num, flagR):
        ...
        if num == 1: 
            ...
            aux = globals()['ambito']
            globals()['ambito'] =''
            if globals()['RetTipo'] != objetoL[5].fuente:
                if globals()['RetTipo'] == '':
                    pass
                else:
            ...
            traductor.Tparam(1, objetoL[1].fuente)
        elif num == 12:
            ...
            if globals()['PrintFlag']==1:
                traductor.Tprint(globals()['printV'])
                globals()['PrintFlag']=0
        elif num == 19:
            ...
            if ExpList!=0:
                for obj in VarList:
                    ...
                    if objetoL[3].fuente == obj.identificador.fuente and obj.listaVar == globals()['ambito']:
                        ...
                        if cont ==0:
                            cont = 1
                            ErrorList.append('Error variable ' + str(objetoL[3].fuente) +'no declarada')
                            aux = 'mmm'
                            aux2 = 'mmm'
                            anadidos +=1
                        else:
                    ...
                    for obj2 in objS.listateraux:
                        if obj.identificador.fuente == objS.listateraux[i].fuente:
                            ...
                            if obj.tipo.fuente != aux:
                                if cont ==0:
                                    ErrorList.append('Tipos de dato diferente en variable: ' + str(aux2.identificador.fuente))
                                    bandera = 1
                                    cont+=1
                            else:
                ...
                if bandera ==1: #ARREGLAR TIPO
                    ...
                    if obj2.tipo != aux:
                        ...
                        if globals()['CallFlag']!=0:
                            ...
                            if cont ==0:
                                ErrorList.append('Tipos de datos diferentes en variable: ' + str(aux2.identificador.fuente) +' tipos de datos diferentes')
                                cont+=1
                    else:
                        if len(OpList)==0:
                            if globals()['callFunc']==0:
                                if esparametro== 0:
                                    traductor.TSen21(21,obj2.fuente, aux2.identificador.fuente) 
                                else:
                                    traductor.TSen21(22,obj2.fuente, aux2.identificador.fuente) 
                            else:
                                globals()['callFunc']=0
                        else:
                            pass
                ...
                if cont ==0 and len(OpList)!=0:
                    for obj5 in TermList:
                        variables.append(Var(obj5.fuente, globals()['ambito']))
                    partederecha = len(variables)
                    if OpList[0] == '+' or OpList[0] == '*':
                        traductor.TOp(OpList, obj.identificador.fuente, variables, globals()['ambito'], partederecha)
                for ter in TermList:
            ...
            traductor.TConI(obj, TermCList, globals()['ElseFlag'])
            TermCList.clear()
            ConList.append(obj)
        elif num == 23:
            ...
            objS = ValorRegresa(objetoL[0], Node('ValorRegresa', parent=root))
            objS.expresion.nodo.parent = objS.nodo
            tipo = ''
            contexto = ''
            i = 0
            ...
            if TermList[-1].tipo == 2:
                ...
                tipo = TermList[-1]
            if tipo == 'float':
                globals()['RetTipo'] = tipo
            elif tipo == 'int':
                globals()['RetTipo'] = tipo
            else:
             globals()['RetTipo'] = tipo.fuente
            variables = list()
            if len(OpList)!=0:
                for obj5 in TermList:
                    variables.append(Var(obj5.fuente, globals()['ambito']))
                partederecha = len(variables)
                traductor.TOp2(OpList, variables, globals()['ambito'], partederecha)
                OpList.clear()
            else:
                traductor.TRet(TermList[-1].fuente, contexto)
            RetList.append(Term2(TermList[-1].fuente, tipo, contexto))
            objetoL.clear()
            return objS
        elif num == 31:
                ...
                if largo <=0 and correcto == 0:
                    for objP in ParamCList:
                        if objP.identificador.fuente == objetoL[0].fuente:
                            ...
                            flagencontrado = 1
                if flagencontrado==1:
                    ErrorList.append('Error variable ' + str(objetoL[0].fuente) +' no declarada')
                try:
            ...
            if len(ParamCList)!=0:
                    ...
                    if objetoL[3].fuente == obj.contexto:
                        ...
                        for obj2 in VarList:
                            ...
                            if TermList[-1].fuente == obj2.identificador.fuente and obj2.listaVar == contexto:
                                ...
                                if obj.tipo.fuente == obj2.tipo.fuente:
                                    ...
                                    bandera2=0
                                    if entre ==0:
                                        traductor.TLlamFunc(TermList, pila[-4].fuente, objetoL[3].fuente)
                                        entre+=1
                        ...
                        if bandera2 ==1:
                            ...
                            if tipo == obj.tipo.fuente:
                                traductor.TLlamFunc2(TermList, pila[-4].fuente, objetoL[3].fuente)
                                break
                            else:
                                bandera = 1
                ...
                if tipo != tipo2:
                    if tipo == 'void':
                        ...
                        ErrorList.append('Error en funcion ' + objetoL[3].fuente)

                if bandera == 1:
                    ErrorList.append('Error en llamada a funcion ' + objetoL[3].fuente)
                globals()['CallFlag']=1
            objetoL.clear()
            return objS
            ...
            if num == 46:
                ...
                TermCList.clear()
                OpList.append(objetoL[1].fuente)
                ExpList.append(obj)
            elif num == 48:
                TermCList.clear()
                ExpList.append(obj)
    ...
    def analizar(self):
        ...
        while True:
            ...
            if obj.fuente == 'print':
                ...
                acc = "NADA"
                ErrorList.append("Error Sintactico")
                break
            elif (accion > 0):
                i+=1
                acc = "d"+str(accion)
                    ...
                    if (accion == (obj2.num + 1)*-1):
                        ...
                        if obj2.elem !=0:
                            ...
                            if obj2.num == 10:
                                ...
                                traductor.TP10(10, globals()['ambito'])
                            elif obj2.num == 12:
                                z = 0
                                posi =2
                                posfi = 6
                                if pila[2].fuente=='Definicion':
                                    ...
                                    globals()['ambito']= pila[4].fuente
                                traductor.TP10(12, globals()['ambito'])
